...
class ControleurServeur(object):
    def __init__(self):
        ...
        self.isStopped = True
        self.seed = int(time())
        self.mess = ['Choisissez la couleur de votre civilisation','________________________________________________________________','Le but est détruire le vaisseau mère des autres équipes','en bâtissant votre propre civilisation et en dominant.','________________________________________________________________']
        self.changeList = []
        self.readyPlayers = []
